...
const UNSPLASH_IMAGES = [
  'https://images.unsplash.com/photo-1677442136019-21780ecad995?w=400&h=400&fit=crop', // AI / neural
  'https://images.unsplash.com/photo-1620712943543-bcc4688e7485?w=400&h=400&fit=crop', // code
  'https://images.unsplash.com/photo-1633356122544-f134324a6cee?w=400&h=400&fit=crop', // AI robot
  'https://images.unsplash.com/photo-1676299085922-a816e6b32b6e?w=400&h=400&fit=crop', // tech
  'https://images.unsplash.com/photo-1485827404703-89b55fcc595e?w=400&h=400&fit=crop', // chip
  'https://images.unsplash.com/photo-1535378620166-273708d44e4c?w=400&h=400&fit=crop', // data
  'https://images.unsplash.com/photo-1550751827-4bd374c3f58b?w=400&h=400&fit=crop', // AI
  'https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=400&h=400&fit=crop', // digital
  'https://images.unsplash.com/photo-1504639725590-34d0984388bd?w=400&h=400&fit=crop', // code
  'https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=400&h=400&fit=crop', // laptop code
]

const AUCTION_CARDS = [
  { title: 'Neural Canvas #042', tags: ['AI', 'Art'], progress: 72, fullPrice: '0.25 ETH', startFrom: 18, startFromTotal: 25, badge: 'Live', statusLabel: 'Live', statusSubtext: '2h left', description: 'AI-generated art drop. Real-time natural events from neural canvas — collectibles, auctions.', typeTag: 'AUCTION', endTime: 'Ends in 2h' },
  { title: 'Code Genesis', tags: ['Dev', 'NFT'], progress: 45, fullPrice: '120 USDC', startFrom: 9, startFromTotal: 20, badge: 'New', statusLabel: 'Live', statusSubtext: '5h left', description: 'Developer NFT collection. Code-based assets and utility.', typeTag: 'AUCTION', endTime: 'Ends in 5h' },
  { title: 'Agent Protocol', tags: ['AI', 'Agent'], progress: 88, fullPrice: '0.5 ETH', startFrom: 44, startFromTotal: 50, badge: 'Hot', statusLabel: 'Live', statusSubtext: '45m left', description: 'Agent protocol access. AI/ML endpoints and rate limits.', typeTag: 'FIXED', endTime: '60/min · 10 burst' },
...
function App() {
  ...
  return (
    <>
        ...
        <div className="flex-1 min-w-0 flex flex-col overflow-hidden">
          <div className="flex-1 min-h-0 overflow-y-auto overflow-x-auto scrollbar-custom">
            <div className="w-full min-w-0 px-4 sm:px-6 pt-6 pb-8">
              {/* Mobile: Filters button above grid */}
      ...
      {/* Mobile filter drawer: overlay + sidebar panel */}
      {filterOpen && (
        <>
          <div
